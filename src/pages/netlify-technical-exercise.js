...
<ul>
 ...
 <li>Once the issue is resolved, we need to thank the person who reported it. They're definitely getting some swag or whatever kinds of things we're empowered to provide to someone who helped us out with something that important.</li>
  ...
  <p>Caveat - I'm going to end up working hours where the 'correct' person might be unavailable so raising a red flag might be more difficult. On the other hand, Netlify is geographically diverse so there may actually be a 'correct' person available during my hours. I just don't know. If there isn't someone on-line, I'm going to assume there's someone designated to be on-call and this may be a time to engage the on-call protocol. I don't mean the support on-call here. I mean, I'm support. We already know. I mean some kind of dev on call. But, ss I said at the earlier, this is a security issue, not an outage so It really depends on the situation. Interrupting someone's off-hours or waking someone up should be a last resort.</p>
<h3>(optional/bonus) Could you give us a suggestion to improve this test or the job posting?</h3>
<p>To be honest, I'm pretty worn out by the process right now so I don't much additional feedback today. I will think about it because that's just how I'm wired. The only thing I can think of immediately isn't really all that helpful but I'll put it out there anyway. I think there's probably a way to rework the last question about the security issue to allow someone to answer more succinctly than I did. I get that we're trying to get insight into someone's thought process and it certainly does but I found it to be a stressful exercise the way it's currently being presented. Maybe that's ok too. :)</p>
